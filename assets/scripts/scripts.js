...
async function birthdayGif() {
  try {
    const response = await fetch('https://api.giphy.com/v1/gifs/random?api_key=GNeXyRWAB7D9CGK8qsM9X214SPFpcXKw&tag=disneyanimation&rating=G'); // This sends the request
